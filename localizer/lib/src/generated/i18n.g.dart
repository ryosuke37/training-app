 ...
 *
 * Built on 2023-07-26 at 13:03 UTC
 */
...
late _I18nEn _translationsEn = _I18nEn.build();
late _I18nJa _translationsJa = _I18nJa.build();
...
extension AppLocaleExtensions on AppLocale {
	...
	_I18nEn build() {
		switch (this) {
			case AppLocale.en: return _I18nEn.build();
			case AppLocale.ja: return _I18nJa.build();
		}
	}
...
class _I18nJa implements _I18nEn {
	...
	@override late final _I18nJa _root = this; // ignore: unused_field
